...
var ImageNames = []string{"Spark with Anaconda and Jupyter","Spark with Anaconda","Spark"}
var ImageAddr = []string{"registry.njuics.cn/bdkit/spark_master_on_kube:latest","registry.njuics.cn/bdkit/spark_master_on_kube:2.1","registry.njuics.cn/wdongyu/spark_master_on_kube:1.0.3"}
